...
export const translations = {
  en: {
    ...
    supportedArtworkFormats: 'Supports PNG / JPG',
    ...
    cornerRadius: 'Edge bevel width in mm',
    bevelSegments: 'Edge bevel segments',
    surface: 'Surface',
    shadows: 'Shadows',
  ...
  zh: {
    ...
    replace: '替换',
    dropArtwork: '上传设计稿',
    supportedArtworkFormats: '支持 PNG / JPG',
